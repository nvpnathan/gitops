...
rootCA="ca.crt" # path of the manually downloaded harbor root CA
gcname="k8s1" # guest cluster name
gcnamespace="prod" # Supervisor cluster namespace where guest cluster get deployed
